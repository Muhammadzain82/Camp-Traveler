...
const Camp = () => {
  return (
    <section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
       <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:[640px]">
        <CampSite 
         backgroundImage="bg-bg-img-1" 
         title = "Putuk Truno Camp"
         subtitle = "Pirgen, Pasuruan"
         peopleJoined = "50+ Joined"
        />
        <CampSite 
          backgroundImage="bg-bg-img-2" 
          title = "Mountain View Camp"
          subtitle = "Somewhere in Wilderness"
          peopleJoined = "50+ Joined"
        />
       </div>

       <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 px-6 lg:max-w[500px] xl:max-w-[743px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          ...
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            ...
            ver large. That's why we are here for those pf you who 
